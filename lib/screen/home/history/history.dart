...
class History  extends StatefulWidget {
  final String url;
  const History  ({super.key, required this.url});

  @override
  State<History  > createState() => _NanjingWebViewState();
}

class _NanjingWebViewState extends State<History  > {
        ...
        appBar: AppBar(
          ...
          actions: [
            IconButton(
              ...
              onPressed: () => Share.share('Nanjing University History  : ${widget.url}'),
            ),
            IconButton(
