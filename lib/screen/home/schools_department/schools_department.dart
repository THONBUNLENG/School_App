...
class SchoolsDepartment extends StatefulWidget {
  final String url;
  const SchoolsDepartment ({super.key, required this.url});

  @override
  State<SchoolsDepartment> createState() => _NanjingWebViewState();
}

class _NanjingWebViewState extends State<SchoolsDepartment> {
        ...
        appBar: AppBar(
          ...
          actions: [
            IconButton(
              ...
              onPressed: () => Share.share('Nanjing University Schools & Department : ${widget.url}'),
            ),
            IconButton(
