...
class Job extends StatefulWidget {
  final String url;
  const  Job ({super.key, required this.url});

  @override
  State<Job> createState() => _NanjingWebViewState();
}

class _NanjingWebViewState extends State<Job> {
        ...
        appBar: AppBar(
          ...
          actions: [
            IconButton(
              ...
              onPressed: () => Share.share('Nanjing University Job Openings : ${widget.url}'),
            ),
            IconButton(
