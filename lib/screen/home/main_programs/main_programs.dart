...
class MainPrograms extends StatefulWidget {
  final String url;
  const MainPrograms({super.key, required this.url});

  @override
  State<MainPrograms> createState() => _NanjingWebViewState();
}

class _NanjingWebViewState extends State<MainPrograms> {
        ...
        appBar: AppBar(
          ...
          actions: [
            IconButton(
              ...
              onPressed: () => Share.share('Nanjing University MainPrograms: ${widget.url}'),
            ),
            IconButton(
