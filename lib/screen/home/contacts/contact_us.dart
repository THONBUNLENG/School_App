              ...
              background: Container(
                ...
                child: const Align(
                  ...
                  child: Padding(
                    ...
                    child: Icon(Icons.contact_page, size: 120, color: Colors.white12),
                  ),
                ),
              ),
            ),
          ...
          SliverToBoxAdapter(
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  _infoCard(
                    title: "Nanjing University Education Development Foundation",
                    content: "163 Xianlin Road, Qixia District, Nanjing, Jiangsu Province, 210023",
                    isDark: isDark,
                  ),
                  _infoCard(
                    title: "Telephone",
                    content: "(86) - 25-89686186",
                    isDark: isDark,
                  ),
                  _infoCard(
                    title: "E-mail",
                    content: "foundation@nju.edu.cn",
                    isDark: isDark,
                  ),
