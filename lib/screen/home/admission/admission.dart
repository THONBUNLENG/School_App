...
class Admission extends StatefulWidget {
  final String url;
  const Admission ({super.key, required this.url});

  @override
  State<Admission > createState() => _NanjingWebViewState();
}

class _NanjingWebViewState extends State<Admission > {
        ...
        appBar: AppBar(
          ...
          actions: [
            IconButton(
              ...
              onPressed: () => Share.share('Nanjing University Admission : ${widget.url}'),
            ),
            IconButton(
